...
public class UAgentInfo {
    ...
    public static final Pattern pdaPattern = Pattern.compile("pda[;| ]", Pattern.CASE_INSENSITIVE); // this is better than just "pda"
    ...
    public boolean detectMobileQuick() {
    	// this is the majority of our mobile devices, so check this first
        ...
        if (pdaPattern.matcher(userAgent).matches()) { return true; }
